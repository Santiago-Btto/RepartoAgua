...
<div class="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-3xl bg-[#0c1222] border border-gray-700 rounded-lg shadow-lg p-6">
        <h3 class="text-xl font-semibold mb-4">Editar cliente</h3>
        <form class="grid grid-cols-1 md:grid-cols-2 gap-3" on:submit|preventDefault={handleSave}>
